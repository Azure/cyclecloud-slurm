...
install_pkg=$(jetpack config slurm.install_pkg azure-slurm-install-pkg-3.0.7.tar.gz)
autoscale_pkg=$(jetpack config slurm.autoscale_pkg azure-slurm-pkg-3.0.7.tar.gz)
