...
def test_generate_single_block():
    ...
    with open("/tmp/topology.txt", "r") as f:
        content = f.read()
    assert "# Mock topology for testing\nBlockName=block_001 Nodes=gpu-1,gpu-2,gpu-3,gpu-4,gpu-5,gpu-6,gpu-7,gpu-8,gpu-9,gpu-10,gpu-11,gpu-12,gpu-13,gpu-14,gpu-15,gpu-16,gpu-17,gpu-18" in content
